...
> [!NOTE]
> You might get flagged as a bot. It is highly recommended to install the `yt-dlp-ejs` python library and a [supported javascript runtime](https://github.com/yt-dlp/yt-dlp/wiki/EJS) in order to avoid detection.
